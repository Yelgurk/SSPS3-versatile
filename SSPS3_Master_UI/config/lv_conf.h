...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (640 * 1024U)          /*[bytes]*/
...
#define LV_USE_CALENDAR   1
    ...
    #define LV_CALENDAR_DEFAULT_MONTH_NAMES {"Янв", "Февр", "Март",  "Апр", "Mай",  "Июнь", "Июль", "Авг", "Сент", "Окт", "Ноя", "Дек"}
